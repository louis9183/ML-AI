...
def get_b64_test_image_for_faith():
    with open('base64.txt') as f:
        return f.read()
if __name__ == '__main__':
    load_saved_artifacts()
    #print(classify_image(get_b64_test_image_for_faith(),None))
    #print(class_number_to_name(1))
    print(classify_image(None,'test_image/louis.JPG'))